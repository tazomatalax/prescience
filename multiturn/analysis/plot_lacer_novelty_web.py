"""Plot LACER novelty time series — web variant with transparent background."""
import os
import random
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Plot LACER novelty time series (web variant).")
    ...
    parser.add_argument("--output_path", type=str, default="figures/multiturn/lacer_novelty_web.png", help="Output figure path")
